...
%define go_import_path  github.com/hashicorp/go-immutable-radix/v2

Name:           go-github-hashicorp-go-immutable-radix-v2
Version:        2.1.0
Release:        %autorelease
Summary:        An immutable radix tree implementation in Golang
License:        MPL-2.0
URL:            https://github.com/hashicorp/go-immutable-radix
#!RemoteAsset:  sha256:b1bb5298511459b33d5c8013ac6cb93f3249d809f0a178d8b80496cd80987600
...
Provides:       go(github.com/hashicorp/go-immutable-radix/v2) = %{version}
